...
//action
import { insertBanner, updateBanner } from "../../Store/Banner/banner.action";

//types
import { CLOSE_BANNER_DIALOG } from "../../Store/Banner/banner.type";
...
const BannerDialog = (props) => {
  ...
  const handleSubmit = () => {
    ...
    if (mongoId) {
      props.updateBanner(formData, mongoId);
    } else {
      props.insertBanner(formData);
    }
  };
...
export default connect(null, { insertBanner, updateBanner })(BannerDialog);
